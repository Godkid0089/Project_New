...
// LocalStorage --> Bidnii oruulsan datag web browserd hadgaldag
// setItem -> datag hadgalna , getItem -> hadgalsan datag duudna , clearItem, removeItem --> hadgalsan datag ustgana
function saveData(){
	localStorage.setItem("name","Smoky");
	localStorage.setItem("age","14");
	localStorage.setItem("toDo",ol.innerText);
}
function getData(){
